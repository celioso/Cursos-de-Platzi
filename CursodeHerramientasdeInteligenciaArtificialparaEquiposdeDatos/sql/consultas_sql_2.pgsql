...
(
    category_id   smallint    not null constraint pk_categories primary key,
...
(
    customer_id      varchar(5) not null constraint fk_customer_customer_demo_customers references customers,
    customer_type_id varchar(5) not null constraint fk_customer_customer_demo_customer_demographics references customer_demographics,
    constraint pk_customer_customer_demo primary key (customer_id, customer_type_id)
);

create table customer_demographics
(
    customer_type_id varchar(5) not null constraint pk_customer_demographics primary key,
    customer_desc    text
);
