...
fruits = []
fruits.append("Kiwi") # agrega un elemento
fruits.append("Berry")
fruits.append("Melon")
fruits.sort() # orgaiza los elementos
fruits.pop() #Elimina el primer elemento
fruits.insert(0, "Apple") # Inserta un elemento
fruits.insert(1, "Strawberry")
fruits.pop(1) #elimina el elemento en la posicion 1
fruits.remove("Apple") #elimina el elemento Apple
