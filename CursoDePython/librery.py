class Book:
    ...
    def borrow(self):
        if self.available:
            ...
            print(f"El libro {self.title} no está disponoble")
...
book2 = Book("1984", "AGeorge Orwell")
...
librery = Librery()
librery.add_book(book1)
librery.add_book(book2)
librery.register_user(user1)

# Mostrar libros
librery.show_available_book()
